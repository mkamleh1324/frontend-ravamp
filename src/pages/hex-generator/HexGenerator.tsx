...
import mockVideo from "../../assets/videos/mock.mp4";
...
const statusLabel = {
  ...
  processing: (
    <>
      <Spinner size="sm" mr={1} /> Processing
    </>
  ),
  pending: <>Pending</>,
};
      ...
      <Box borderWidth="1px" borderRadius="lg" p={4} mb={8} bg={"white"}>
        <HStack marginBottom={20}>
          ...
          <HStack w={"50%"} justifyContent={"end"}>
            ...
            <Select.Root collection={frameworks} size="sm" width="100px">
              <Select.HiddenSelect />
              <Select.Label>Picture Model</Select.Label>
              <Select.Control>
                <Select.Trigger>
                  <Select.ValueText placeholder="Select framework" />
                </Select.Trigger>
            ...
            <Select.Root collection={frameworks} size="sm" width="100px">
              <Select.HiddenSelect />
              <Select.Label>Picture Count</Select.Label>
              <Select.Control>
                <Select.Trigger>
                  <Select.ValueText placeholder="Select framework" />
                </Select.Trigger>
              ...
              <Accordion.Item key={index} value={item.status} h={"fit-content"}>
                ...
                <Accordion.ItemContent>
                  ...
                  <Flex gap="4" w={"100%"} padding={10}>
                            ...
                            {images.map((item, index) => (
                              ...
                              >
                                ...
                                <RadioCard.ItemControl>
                                  <RadioCard.ItemText>
                                    <ImageOption key={item} image={item} />
                                  </RadioCard.ItemText>
                                </RadioCard.ItemControl>
                              </RadioCard.Item>
                            ))}
                    ...
                    <Box flexGrow={1}>
                      <VStack align="start" gap={3}>
                        <Heading size="sm">🖼 Animation Instructions</Heading>
                        <Textarea
                          value={"this is text"}
                          onChange={() => {}}
                          maxLength={50000}
                          placeholder="Enter video animation prompt here..."
                          height="120px"
                        />
                        <Text fontSize="sm" color="gray.500">
                          {500}/{100000} characters
                        ...
                        >
                          <Select.HiddenSelect />
                          <Select.Label>Animation Model</Select.Label>
                          <Select.Control>
                            <Select.Trigger>
                              <Select.ValueText placeholder="Select framework" />
                            </Select.Trigger>
                        ...
                        <Button variant="outline">regenerate Video</Button>
                      </VStack>
                    </Box>
                  </Flex>
                </Accordion.ItemContent>
